 ...
 * @author agar
 */
public class LBobotNilai extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("LAPORAN DATA BOBOT NILAI");
    ...
    private void bCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCetakActionPerformed
        // TODO add your handling code here:
         try {
            String LBobotNilai = "src/Report/LBobotNilai.jasper";
            Connection connection = new koneksi().connect();
            HashMap<String, Object> parameter = new HashMap();
            File report_file = new File (LBobotNilai);
